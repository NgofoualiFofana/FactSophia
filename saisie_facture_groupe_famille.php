...
<!--***UTILISATION DES ICONES FONTAWESOME***!-->
    ...
    <title>Saisie - Facture groupe - Famille</title>
  </head>
  <body>
    ...
    <div class="container">
      <table class="table table-striped table-condensed">
        <thead>
          <th>
            <h4>
              <i class="fa fa-users fa-2x "></i> SAISIE FACTURE - GROUPE - FAMILLE
            </h4>
          ...
          <tr>
            <td class="col-md-6">
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label for="text" class="col-md-3 control-label">Numéros de Chambres:</label>
                  <div class="col-md-3">
                ...
                <div class="form-group">
                  <label for="text" class="col-md-3 control-label">Total Montant Nuitées:</label>
                  <div class="col-md-3">
                    <input type="text" class="form-control" id="text">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="text" class="col-md-3 control-label">Nombre de nuitées:</label>
                  <div class="col-md-3">
                    <input type="text" class="form-control" id="text">
                  </div>
                </div>
            ...
            <td class="col-md-6">
              ...
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <label for="text" class="col-md-3 control-label">Supplément Personnes:</label>
                  <div class="col-md-3">
                    <input type="text" class="form-control" id="text">
                  </div>
                </div>
