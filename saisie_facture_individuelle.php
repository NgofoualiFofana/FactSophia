...
<!--***UTILISATION DES ICONES FONTAWESOME***!-->
    ...
    <title>Saisie - Facture Individuelle</title>
  </head>
  <body>
    ...
    <div class="container">
      <table class="table table-striped table-condensed">
        <thead>
          <th>
            <h4>
              <i class="fa fa-user-o fa-2x "></i> SAISIE FACTURE - INDIVIDUELLE
            </h4>
          ...
          <tr>
            <td class="col-md-6">
              <form class="form-horizontal" method="post" action="">
                ...
                <div class="form-group">
                  <label for="text" class="col-md-3 control-label">P/C :</label>
                  <div class="col-md-3">
                    <input type="text" class="form-control" id="text">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="text" class="col-md-3 control-label">Chambre N:</label>
                  <div class="col-md-3">
                ...
                <div class="form-group">
                  <label for="text" class="col-md-3 control-label">Prix nuitée:</label>
                  <div class="col-md-3">
                    <input type="text" class="form-control" id="text">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="text" class="col-md-3 control-label">Nbre de jours:</label>
                  <div class="col-md-3">
                    <input type="text" class="form-control" id="text">
                  </div>
                </div>
...
<!--2eme Colonne du tableau-->
            ...
            <td class="col-md-6">
              ...
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label for="text" class="col-md-3 control-label">Hébergement:</label>
                  <div class="col-md-3">
                    <input type="text" class="form-control" id="text">
                  </div>

                  <label for="text" class="col-md-3 control-label">Supplément:</label>
                  <div class="col-md-3">
                    <input type="text" class="form-control" id="text">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="text" class="col-md-3 control-label">Acompte:</label>
                  <div class="col-md-3">
                    <input type="text" class="form-control" id="text">
                  </div>
...
<!-- ******Code Javascript d'exécution après appui sur le bouton Editer Facture-->
<script type="text/javascript">
Etes-vous sûre de vouloir vraiment éditer cette facture ?
